...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="background: #e7e7e7; width: 100%; height: 100%; margin: 0; padding: 0;">
	...
	<div id="mailsub">
		...
		<p>This is your email verification code probably you have initiated an account request . if not report this activity immidiately </p>
	    <p>${data.code}</p><br/>
